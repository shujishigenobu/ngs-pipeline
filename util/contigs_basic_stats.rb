...
SIZE_BREAKS = [100, 200, 300, 400, 500, 1000, 2000, 3000, 4000, 5000, 10000]
...
puts "#=== RNAseq Contigs Basic Statistics === "
puts "#"
...
%w{num_contigs shortest longest mean median N50 N90 total_bases total_bases_atgc}.each do |k|
  puts [k, data[k]].join("\t")
end
puts "#"
puts "### Nucleotide Counts"
puts "# " + %w{A T G C}.map{|b| "#{b}: #{base_count[b]}"}.join(", ")
puts "# Others: #{data['total_bases'] - data['total_bases_atgc']}"
